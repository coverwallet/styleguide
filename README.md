...
If you found icons that you was looking in the list, you need to proceed to 10-13 steps
...
9. Replace old fonts
10. Add css classes per category (industries, subindustries, onlyclick, etc) and add new icons to the sections example layout
